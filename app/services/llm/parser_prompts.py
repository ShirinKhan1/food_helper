...
- intent: search_recipes | recommend_recipes | nutrition_question | ingredient_substitution | general_substitution | recipe_details | similar_recipes | allergy_or_exclusion | conversation_recall | fallback
